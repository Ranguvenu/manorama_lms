...
class quiz_attempt {
    ...
    public function process_finish($timestamp, $processsubmitted, $timefinish = null, $studentisonline = false) {
        ...
        // $customquestion = (new \theme_horizon\custom_question_usage($this->quba->get_owning_component(), $this->quba->get_owning_context()));
        // $this->attempt->sumgrades = $customquestion->get_total_marks();
        $this->attempt->sumgrades = $this->quba->get_total_mark();
        ...
        $gradecalculator->recompute_all_attempt_sumgrades($this->get_userid());
