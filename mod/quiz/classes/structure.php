...
class structure {
    ...
    protected function populate_structure() {
        global $DB;
        $classname = "\\local_questions\\bank\\qbankhelper";
        if(class_exists($classname)){
        $slots = \local_questions\bank\qbankhelper::get_question_structure($this->quizobj->get_quizid(), $this->quizobj->get_context());
        }else{
