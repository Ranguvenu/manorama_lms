...
if ($ADMIN->fulltree) {
    ...
    // Zoom admin user email for zoom setting.
    $settings->add(new admin_setting_configtext('zoom/adminuseremail',
            get_string('adminuseremail', 'mod_zoom'),
            get_string('adminuseremaildesc', 'mod_zoom'), '', PARAM_RAW_TRIMMED)); 
