...
$string['zoomerr_meetingnotfound_info'] = 'This meeting has been canceled and can not be found on zoom.';
$string['zoomerr_meetingnotfound_info_to_user'] = 'This meeting has been canceled.';
...
$string['filesforzoom'] = 'Zoom Files';
$string['lessonplan'] = 'Lesson Plan';
$string['classnotes'] = 'Class Notes';
$string['strfshttimedaydate'] = '%a %d-%b-%Y';
$string['adminuseremail'] = 'Admin User Email';
$string['adminuseremaildesc'] = 'Admin user email for zoom activity create setting';
$string['zduration'] = 'Duration';
