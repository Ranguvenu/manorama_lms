 ...
 *
 * @module     local_onlineexams/paged_content_factory
...
[
    ...
    'core/templates',
    'core/notification',
    'local_onlineexams/paged_content',
    'local_onlineexams/paged_content_pages',
    'core/pubsub',
    'core/ajax'
],
function(
    ...
    var TEMPLATES = {
        PAGED_CONTENT: 'local_onlineexams/paged_content'
    };
