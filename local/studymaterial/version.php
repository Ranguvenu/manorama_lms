...
$plugin->version   = 2023102700.03;  // The current plugin version (Date: YYYYMMDDXX).
$plugin->requires  = 2023042400; // Requires this Moodle version.
$plugin->component = 'local_studymaterial'; // Full name of the plugin (used for diagnostics)
