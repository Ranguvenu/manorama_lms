...
define(
    ...
    var requestQuestions = function(
        ...
        var request = {
            ...
            methodname: 'local_questions_get_random_question_summaries',
            args: {
     ...
     * @return {promise} Resolved when the preview section has rendered.
     */
    var reload = function(root, categoryId, includeSubcategories, tagIds, contextId, goalid, boardid, classid, courseid,coursetopicsid, chapterid, unitid, conceptid) {
        // Show the loading spinner to tell the user that something is happening.
        showLoadingIcon(root);
        // Load the first set of questions.
        return requestQuestions(categoryId, includeSubcategories, tagIds, contextId, ITEMS_PER_PAGE, 0, goalid, boardid, classid, courseid,coursetopicsid, chapterid, unitid, conceptid)
            .then(function(response) {
