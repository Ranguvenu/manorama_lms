 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class questionsummaryexporter extends \core\external\exporter {
    ...
    protected static function define_other_properties() {
        return [
            'icon' => [
                'type' => questionsummaryexporter::read_properties_definition(),
            ]
        ];
    }
    ...
    protected function get_other_values(\renderer_base $output) {
        $iconexporter = new questionsummaryexporter($this->question, $this->related);
