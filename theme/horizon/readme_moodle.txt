...
* remove folder theme/horizon/scss/bootstrap
* copy the scss files from ~/bootstrap/scss to theme/horizon/scss/bootstrap
...
* comment out this line in theme/horizon/scss/_print.scss
    @page {
...
* remove folder theme/horizon/amd/src/bootstrap
* copy the js files from ~/bootstrap/js/src to theme/horizon/amd/src/bootstrap (including the subfolder)
* copy index.js from ~/bootstrap/js to theme/horizon/amd/src
* edit theme/horizon/amd/src/index.js and update import path (src -> bootstrap)
...
* in folder theme/horizon run "grunt amd" to compile the bootstrap JS
* in folder theme/horizon run "grunt css" to compile scss
