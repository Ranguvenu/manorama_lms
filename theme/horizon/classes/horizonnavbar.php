...
/**
 * Creates a navbar for horizon that allows easy control of the navbar items.
 *
 * @package    theme_horizon
 * @copyright  2021 Adrian Greeve <adrian@moodle.com>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class horizonnavbar implements \renderable {
    ...
    public function __construct(\moodle_page $page) {
        ...
        $this->prepare_nodes_for_horizon();
    }

    /**
     * Prepares the navigation nodes for use with horizon.
     */
    protected function prepare_nodes_for_horizon(): void {
        global $PAGE;
    ...
    /**
     * Get all the horizonnavbaritem elements.
     *
     * @return horizonnavbaritem[] Horizon navbar items.
     */
    ...
    /**
     * Removes all navigation items out of this horizon navbar
     */
    ...
    /**
     * Remove a horizonnavbaritem from the horizon navbar.
     *
     * @param  string|int $itemkey An identifier for the horizonnavbaritem
     * @param  int|null $itemtype An additional type identifier for the horizonnavbaritem (optional)
     */
    ...
    /**
     * Removes the action from the last item of the horizonnavbaritem.
     */
