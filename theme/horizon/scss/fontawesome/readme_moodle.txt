...
2. SCSS:
  a. Replace the files in this folder (/theme/horizon/scss/fontawesome) with the files in the scss folder.
  b. Copy the LICENSE.txt file from the root to theme/horizon/scss/fontawesome.
  c. Update theme/horizon/thirdpartylibs.xml.
