...
class reportbase {
   ...
   public function build_query($count = false) {
    ...
    if($this->reporttype == 'table'){
        ...
        if ($this->config->type != 'userattendance' && $this->config->type != 'attendanceoverview' && $this->config->type != 'monthlysessions' && $this->config->type != 'weeklysessions' && $this->config->type != 'dailysessions' && $this->config->type != 'upcomingactivities' && $this->config->type != 'pendingactivities' && $this->config->type != 'chapterwisereport' && $this->config->type != 'testscorereport' && $this->config->type != 'testscoredetails' && $this->config->type != 'liveclassattendance'){
