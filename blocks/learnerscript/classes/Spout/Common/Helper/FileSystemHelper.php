...
class FileSystemHelper
{
     ...
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create the folder or if the folder path is not inside of the base folder
     */
     ...
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create the file or if the file path is not inside of the base folder
     */
     ...
     * @return void
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If the file path is not inside of the base folder
     */
     ...
     * @return void
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If the folder path is not inside of the base folder
     */
     ...
     * @return void
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If the folder where the I/O operation should occur is not inside the base folder
     */
