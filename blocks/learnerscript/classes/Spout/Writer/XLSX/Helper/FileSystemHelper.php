...
use block_learnerscript\Spout\Writer\Common\Helper\ZipHelper;
use block_learnerscript\Spout\Writer\XLSX\Internal\Worksheet;
 ...
 */
class FileSystemHelper extends \block_learnerscript\Spout\Common\Helper\FileSystemHelper
{
     ...
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create the folder
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create the folder or the ".rels" file
     */
     ...
     *
     * @return FileSystemHelper
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create the file
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create the folder or one of the files
     */
...
EOD;
     ...
     *
     * @return FileSystemHelper
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create at least one of the folders
     */
