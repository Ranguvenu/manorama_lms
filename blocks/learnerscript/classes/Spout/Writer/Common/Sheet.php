...
namespace block_learnerscript\Spout\Writer\Common;

use block_learnerscript\Spout\Common\Helper\StringHelper;
use block_learnerscript\Spout\Writer\Exception\InvalidSheetNameException;
...
class Sheet
{
    ...
    /** @var \block_learnerscript\Spout\Common\Helper\StringHelper */
     ...
     * @return Sheet
     * @throws \block_learnerscript\Spout\Writer\Exception\InvalidSheetNameException If the sheet's name is invalid.
     */
