...
use block_learnerscript\Spout\Writer\Exception\SheetNotFoundException;
 ...
 *
 * @package block_learnerscript\Spout\Writer\Common
 */
abstract class AbstractWorkbook implements WorkbookInterface
{
    ...
    /**
     * @return \block_learnerscript\Spout\Writer\Common\Helper\AbstractStyleHelper The specific style helper
     */
     ...
     * The writing will resume where it stopped (i.e. data won't be truncated).
     *
     * @param \block_learnerscript\Spout\Writer\Common\Sheet $sheet The "external" sheet to set as current
     * @return void
     * @throws \block_learnerscript\Spout\Writer\Exception\SheetNotFoundException If the given sheet does not exist in the workbook
     */
     ...
     *
     * @param \block_learnerscript\Spout\Writer\Common\Sheet $sheet
     ...
     * @return void
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If trying to create a new sheet and unable to open the sheet for writing
     * @throws \block_learnerscript\Spout\Writer\Exception\WriterException If unable to write data
     */
