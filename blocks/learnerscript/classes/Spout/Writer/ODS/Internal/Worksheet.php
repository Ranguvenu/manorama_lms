...
namespace block_learnerscript\Spout\Writer\ODS\Internal;
...
use block_learnerscript\Spout\Common\Helper\StringHelper;
use block_learnerscript\Spout\Writer\Common\Helper\CellHelper;
use block_learnerscript\Spout\Writer\Common\Internal\WorksheetInterface;
 ...
 *
 * @package block_learnerscript\Spout\Writer\ODS\Internal
 */
class Worksheet implements WorksheetInterface
{
    /** @var \block_learnerscript\Spout\Writer\Common\Sheet The "external" sheet */
    protected $externalSheet;

    /** @var string Path to the XML file that will contain the sheet data */
    protected $worksheetFilePath;

    /** @var \block_learnerscript\Spout\Common\Escaper\ODS Strings escaper */
    protected $stringsEscaper;

    /** @var \block_learnerscript\Spout\Common\Helper\StringHelper To help with string manipulation */
    ...
    /**
     * @param \block_learnerscript\Spout\Writer\Common\Sheet $externalSheet The associated "external" sheet
    ...
    public function __construct($externalSheet, $worksheetFilesFolder)
    {
        ...
        $this->stringsEscaper = \block_learnerscript\Spout\Common\Escaper\ODS::getInstance();
