...
namespace block_learnerscript\Spout\Writer\ODS\Helper;

use block_learnerscript\Spout\Writer\Common\Helper\ZipHelper;
use block_learnerscript\Spout\Writer\ODS\Internal\Worksheet;
 ...
 *
 * @package block_learnerscript\Spout\Writer\ODS\Helper
 */
class FileSystemHelper extends \block_learnerscript\Spout\Common\Helper\FileSystemHelper
{
     ...
     *
     * @return FileSystemHelper
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If unable to create the folder or the "manifest.xml" file
     */
