...
use block_learnerscript\Spout\Reader\Exception\ReaderNotOpenedException;
...
abstract class AbstractReader implements ReaderInterface
{
     ...
     * @param  string $filePath Path of the file to be read
     * @return void
     * @throws \block_learnerscript\Spout\Common\Exception\IOException If the file at the given path does not exist, is not readable or is corrupted
     */
