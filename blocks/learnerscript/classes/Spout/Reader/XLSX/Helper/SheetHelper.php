...
use block_learnerscript\Spout\Reader\XLSX\Sheet;
...
class SheetHelper
{
     ...
     * @param \block_learnerscript\Spout\Reader\XLSX\Helper\SharedStringsHelper Helper to work with shared strings
     ...
     *
     * @param \block_learnerscript\Spout\Reader\Wrapper\XMLReader $xmlReaderOnSheetNode XML Reader instance, pointing on the node describing the sheet, as defined in "workbook.xml"
     * @param int $sheetIndexZeroBased Index of the sheet, based on order of appearance in the workbook (zero-based)
     * @return \block_learnerscript\Spout\Reader\XLSX\Sheet Sheet instance
     */
