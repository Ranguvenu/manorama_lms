...
class report_needgrading extends reportbase implements report {
    ...
    function where() {
        ...
        $this->sql .= " WHERE co.visible = 1 AND cm.visible = 1 AND m.visible = 1 
                        ...
                        AND cxt.contextlevel =50 AND rl.userid = $userid AND rl.roleid = 3) AND gg.finalgrade is null AND gi.itemmodule = 'assign' AND gg.timecreated is not null AND m.name = gi.itemmodule";
