...
class report_practicequestions extends reportbase implements report {
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->columns = array("practicequestionscolumns" => array('studentname', 'course', 'chaptertopic', 'attempted', 'answered', 'correct', 'wrong', 'totalquestions'));
