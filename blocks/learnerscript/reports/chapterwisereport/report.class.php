...
class report_chapterwisereport extends reportbase implements report {
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->columns = array("chapterwisecolumns" => array('chapter', 'liveclass', 'practicetest', 'reading', 'video', 'testscore'));
        $this->parent = false;
