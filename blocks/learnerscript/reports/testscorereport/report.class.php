...
use html_writer;
use DateTime;
class report_testscorereport extends reportbase implements report {
    ...
    public function __construct($report, $reportproperties) {
        ...
        $this->columns = array("testscorereportcolumns" => array('datetime', 'studentname', 'course', 'activity', 'chaptertopic', 'score', 'status', 'scorecard', 'modulename'));
