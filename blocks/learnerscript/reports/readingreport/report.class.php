...
class report_readingreport extends reportbase implements report {
    ...
    public function __construct($report, $reportproperties) {
        ...
        $columns = ['studentname', 'course', 'chaptertopic', 'timespend', 'status', 'section'];
        $this->columns = ['readingreportcolumns' => $columns];
    ...
    function where() {
        $this->sql .= " WHERE p.pagetype = 0 AND ra.contextid = ctx.id AND ctx.contextlevel = 50 AND c.visible = 1";
