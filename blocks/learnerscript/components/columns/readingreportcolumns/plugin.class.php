...
class plugin_readingreportcolumns extends pluginbase {

    public function init() {
        $this->fullname = get_string('readingreport', 'block_learnerscript');
        $this->type = 'undefined';
        $this->form = true;
        $this->reporttypes = array('readingreport');
    }
            ...
            case 'chaptertopic':
                if(isset($row->sectionid) && !empty($row->sectionid)) {
                    ...
                    if($topic) {
                        ...
                        $row->{$data->column} = '<div class="reportchapters">'.$chaptername.'</div><div class="text-muted reporttops">'.$topicname.'</div>';
                    } else {
                        ...
                        $row->{$data->column} = '<div class="reportchapters">'.$chaptername.'</div>';
                    }
                } else {
                    $row->{$data->column} = 'NA';
                }
