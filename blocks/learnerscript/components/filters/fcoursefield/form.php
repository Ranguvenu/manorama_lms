...
class fcoursefield_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'crformheader', get_string('fcoursefield', 'block_learnerscript'), '');
        ...
        $mform->addElement('select', 'field', get_string('field', 'block_learnerscript'), $coursecolumns);
