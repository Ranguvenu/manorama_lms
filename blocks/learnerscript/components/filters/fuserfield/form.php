...
class fuserfield_form extends moodleform {
    ...
    public function definition() {
        ...
        $mform->addElement('header', 'crformheader', get_string('fuserfield', 'block_learnerscript'), '');
        ...
        $mform->addElement('advcheckbox', 'excludedeletedusers', get_string('excludedeletedusers', 'block_learnerscript'));
