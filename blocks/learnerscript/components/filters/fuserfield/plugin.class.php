...
class plugin_fuserfield extends pluginbase {

    public function init() {
        $this->form = true;
        $this->unique = false;
        $this->singleselection = true;
        $this->fullname = get_string('fuserfield', 'block_learnerscript');
        $this->reporttypes = array('users', 'sql', 'scorm_activities_course');
    }
