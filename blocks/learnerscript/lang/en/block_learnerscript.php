...
$string['views'] = 'Views';
$string['studentwisechapters'] = 'Student wise chapters';
$string['filter_chapters'] = 'Select chapters';
$string['chapters'] = 'Chapters';
$string['filterchapters'] = 'Select chapters';
$string['filter_goals'] = 'Select goals';
$string['goals'] = 'Goals';
$string['filtergoals'] = 'Select goals';
$string['chapterwisereport'] = 'Chapter wise Report';
$string['report_chapterwisereport'] = 'Chapter wise report';
$string['chapterreport'] = 'Chapter wise Report';
$string['report_chapterreport'] = 'Chapter wise report';
$string['chapterwisecolumns'] = 'Chapter wise columns';
$string['report_chapterwisereport_help'] = 'Chapter wise report';
$string['liveclassreport'] = 'Live Class Report';
$string['report_liveclassreport'] = 'Liveclass report';
$string['liveclassreportcolumns'] = 'Liveclass report columns';
$string['report_liveclassreport_help'] = 'Liveclass report';
$string['chapter'] = 'Chapter';
$string['topic'] = 'Topic';
$string['attended'] = 'Present';
$string['partialpresent'] = 'Partially present';
$string['missed'] = 'Missed';
$string['notstarted'] = 'Not started';
$string['chapterdetailsreport'] = 'Chapter details report';
$string['report_chapterdetails'] = 'Chapter details report';
$string['chapterdetailscolumns'] = 'Chapter details columns';
$string['report_chapterdetailsreport_help'] = 'Chapter details report';
$string['stacked'] = 'Stacked';
$string['report_studentwisechapters'] = 'Student wise chapters';
$string['readingreport'] = 'Reading Report';
$string['report_readingreport'] = 'Reading report';
$string['readingreportcolumns'] = 'Reading report columns';
$string['report_readingreport_help'] = 'Reading report';
$string['completed'] = 'Completed';
$string['learning'] = 'Learning';
$string['status'] = 'Status';
$string['selectstatus'] = 'Select status';
$string['report_testscorereport'] = 'Test Score report';
$string['retestscoreportcolumns'] = 'Test Score report columns';
$string['report_testscorereport_help'] = 'Test Score report';
$string['submitted'] = 'Submitted';
$string['report_practicequestions'] = 'Practice Questions Report';
$string['practicequestionscolumns'] = 'Practice Questions report columns';
$string['report_practicequestions_help'] = 'Practice Questions report';
$string['testscorereport'] = 'Test Score Report';
$string['practicequestions'] = 'Practice Questions Report';
$string['practicequestionsdetails'] = 'Practice Questions report';
$string['report_practicequestionsdetails'] = 'Practice Question Details report';
$string['report_liveclassdetails'] = 'Live Class Details Report';
$string['report_testscoredetails'] = 'Test Score Details Report';
$string['report_readingdetails'] = 'Reading Details report';
$string['report_liveclassattendance'] = 'Live class attendance report';
$string['liveclassattendancecolumns'] = 'Live Class Attendance columns';
