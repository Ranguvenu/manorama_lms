...
function user_not_fully_set_up($user, $strict = true) {
    ...
    if (empty($user->firstname) /*or empty($user->lastname)*/ or empty($user->email) or over_bounce_threshold($user)) {// Removing user lastname as it is not mandatory for manorama users.
        return true;
    }
