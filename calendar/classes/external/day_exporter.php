...
class day_exporter extends exporter {
    ...
    protected function get_other_values(renderer_base $output) {
        ...
        $cday =  usergetdate($date);
        
        switch ($cday['wday']){
          
          case 0:
              $return['daycode'] = get_string('sun', 'calendar');
              $return['dayname'] = get_string('sunday', 'calendar');
          break;
          case 1:
              $return['daycode'] = get_string('mon', 'calendar');
              $return['dayname'] = get_string('monday', 'calendar');
          break;
          case 2:
              $return['daycode'] = get_string('tue', 'calendar');
              $return['dayname'] = get_string('tuesday', 'calendar');
          break;
          case 3:
              $return['daycode'] = get_string('wed', 'calendar');
              $return['dayname'] = get_string('wednesday', 'calendar');
          break;
          case 4:
              $return['daycode'] = get_string('thu', 'calendar');
              $return['dayname'] = get_string('thrusday', 'calendar');
          break;
          case 5:
              $return['daycode'] = get_string('fri', 'calendar');
              $return['dayname'] = get_string('friday', 'calendar');
          break;
          case 6:
              $return['daycode'] = get_string('sat', 'calendar');
              $return['dayname'] = get_string('saturday', 'calendar');
          break;
          default:
              $return['daycode'] = '';
              $return['dayname'] = '';
