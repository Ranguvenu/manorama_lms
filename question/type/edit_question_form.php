...
abstract class question_edit_form extends question_wizard_form {
    ...
    protected function definition() {
        ...
        $mform->addElement('text', 'idnumber', get_string('qnumber', 'local_questions'), 'maxlength="100"  size="10"');
        ...
        $buttonarray[] = $mform->createElement('submit', 'updatebutton',
         ...
         $buttonarray[] = $mform->createElement('submit', 'updatebuttoncopy',
               get_string('copyandsave', 'question'));
