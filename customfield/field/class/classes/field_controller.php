...
class field_controller extends \core_customfield\field_controller {
     ...
     * @return array
     */
    public function get_options_class(): array {
        global $DB;
        $classlist= $DB->get_records_sql_menu("SELECT lh.id as id,lh.name as fullname FROM {local_hierarchy} lh  WHERE lh.depth=3");
