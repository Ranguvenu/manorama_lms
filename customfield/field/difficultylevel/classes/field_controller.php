...
class field_controller extends \core_customfield\field_controller {
    ...
    public function get_options(): array {
        global $DB;
        $difficultylist= $DB->get_records_sql_menu("SELECT qc.questionid id,qc.difficulty_level fullname FROM {local_questions_courses} as qc 
        WHERE 1=1");
